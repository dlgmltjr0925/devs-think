  ...
  return (
    <div className="relative">
      ...
      <div className="text-foreground relative h-[600px] border-gray-300">
        {/* 가장 낮은 z-index */}
        <div className="bg-primary text-primary-contrast-text absolute top-4 left-4 z-(--z-mobile-stepper) h-60 w-60 rounded-lg p-4 shadow-lg">
        ...
        {/* 가장 높은 z-index */}
        <div className="bg-secondary-light text-secondary-contrast-text absolute top-60 left-60 z-(--z-tooltip) h-60 w-60 rounded-lg p-4 shadow-lg">
          <div className="absolute top-1 left-2 text-sm font-medium">
            tooltip (1500)
          </div>
        </div>

        <div className="bg-primary-light text-primary-contrast-text absolute top-52 left-52 z-(--z-snackbar) h-60 w-60 rounded-lg p-4 shadow-lg">
          <div className="absolute top-1 left-2 text-sm font-medium">
            snackbar (1400)
          </div>
        </div>

        <div className="bg-success text-success-contrast-text absolute top-44 left-44 z-(--z-modal) h-60 w-60 rounded-lg p-4 shadow-lg">
          <div className="absolute top-1 left-2 text-sm font-medium">
            modal (1300)
          </div>
        </div>

        <div className="bg-info text-info-contrast-text absolute top-36 left-36 z-(--z-drawer) h-60 w-60 rounded-lg p-4 shadow-lg">
          <div className="absolute top-1 left-2 text-sm font-medium">
            drawer (1200)
          </div>
        </div>

        <div className="bg-warning text-warning-contrast-text absolute top-28 left-28 z-(--z-app-bar) h-60 w-60 rounded-lg p-4 shadow-lg">
          <div className="absolute top-1 left-2 text-sm font-medium">
            app-bar (1100)
          </div>
        </div>
        ...
        <div className="bg-secondary text-secondary-contrast-text absolute top-12 left-12 z-(--z-fab) h-60 w-60 rounded-lg p-4 shadow-lg">
          <div className="absolute top-1 left-2 text-sm font-medium">
            fab (1050)
          </div>
        </div>

        <div className="bg-error text-error-contrast-text absolute top-20 left-20 z-(--z-speed-dial) h-60 w-60 rounded-lg p-4 shadow-lg">
          <div className="absolute top-1 left-2 text-sm font-medium">
            speed-dial (1050)
          </div>
        </div>
